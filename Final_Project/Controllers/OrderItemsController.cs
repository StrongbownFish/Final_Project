...
namespace Final_Project.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderItemId,OrderId,MenuItemId,Quantity,Price")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderItemId,OrderId,MenuItemId,Quantity,Price")] OrderItem orderItem)
        {
            if (ModelState.IsValid)
            {
